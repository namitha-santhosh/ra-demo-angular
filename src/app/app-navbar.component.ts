  ...
  template: `
    <nav class='navbar navbar-expand navbar-light bg-light'>
      ...
      <ul class='navbar-nav'>
        ...
        <li class='nav-item' *ngIf="authService.isAuthenticatedUser() && !authService.isAdmin()"><a class='nav-link' routerLinkActive='active' [routerLink]="['/category']">Categories</a></li>
        <li class='nav-item' *ngIf="authService.isAdmin()"><a class='nav-link' routerLinkActive='active' [routerLink]="['/admin']">View Dashboard</a></li>
        <li class='nav-item' *ngIf="authService.isAuthenticatedUser() && !authService.isAdmin()"><a class='nav-link' routerLinkActive='active' [routerLink]="['/cart']">View Cart</a></li>
